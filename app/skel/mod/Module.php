...
class Module implements ModuleDefinitionInterface
{
    ...
    public function registerAutoloaders()
    {
        ...
        $loader->registerNamespaces(
            array(
                '[module_namespace]\Controllers' => MODULES_DIR . $this->module_name . DS . 'controllers' . DS,
                '[module_namespace]\Models' => MODULES_DIR . $this->module_name . DS . 'models' . DS,
            )
        );
    ...
    public function registerServices($di)
    {
        ...
        $di->set('dispatcher', function () {
            ...
            $dispatcher->setDefaultNamespace("[module_namespace]\Controllers\\");
